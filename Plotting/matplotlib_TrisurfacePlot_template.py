#! /usr/bin/env python 
##################################################################################
# matplotlib_TrisurfacePlot_template
# 
# A template to help create tri-surface figures with Matplotlib and Scipy
#
...
#
# Created: 09/21/16 - Joshua Vaughan - joshua.vaughan@louisiana.edu
#
# Modified: 
#   * 
#
...
# 
# # In NumPy, we can pass the grid variables to functions
# heights = np.sin(np.sqrt(x_grid**2 + y_grid**2))

# If z is an array, then you might have to use the gridddata command, as below
...
surf = ax.plot_trisurf(x, y, z, linewidth=0, rstride=1, cstride=1, alpha=0.85, cmap=plt.cm.bwr)
