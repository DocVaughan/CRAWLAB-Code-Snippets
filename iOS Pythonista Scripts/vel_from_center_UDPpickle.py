...
class MyScene (Scene):
	def setup(self):
		...
		self.HOST, self.PORT = '10.0.1.110', 2390
	...
	def draw(self):
		...
		# Use the Python pickle to send velocity as a tuple
		#  Need Python "unpickle" on the other side
		#  If recipient is also Python, this may be more convenient than sending strings
		data = pickle.dumps(self.velocity.as_tuple())
	...
	def touch_ended(self, touch):
		...
		# Animate the "bubble" back to the center when the touch ends
