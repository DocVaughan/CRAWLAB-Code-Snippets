...
while position_error > 1e-3:
    ...
    # Now, we can use the transpose of the Jacobian to solve for the angles to move
    # the system endpoint to the desired position
    # delta_joint_angles = current_jacobian.transpose() * desired_delta_pos
    
    # Or try the pseudo-inverse instead, which should converge to the solution
    # more quickly
    delta_joint_angles = current_jacobian.pinv() * desired_delta_pos
