...
#
# Basic use of interrupts with momentary on/off of motor in one direction
#  Uses the SparkFun TB6612FNG breakout board - http://sfe.io/p9457
#
...
if __name__ == '__main__':
    ...
    GPIO.setup(CCWswitch, GPIO.IN)
  
    # now we'll define the threaded callback function  
    # this will run in another thread when our event is detected  
    def CW_ON_callback(channel):  
        if motorA.isRunning:
            ...
            # We can't run the other direction at the same time. This is good.
    ...
    # now we'll define the threaded callback function  
    # this will run in another thread when our event is detected  
    def CCW_ON_callback(channel):  
        if motorA.isRunning:
            print 'Motor is already running...'            
        else:
            print 'Starting the motor CCW...'
