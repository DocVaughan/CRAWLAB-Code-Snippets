...
struct st_hcan2 {                                       /* struct HCAN2 */
                union {                                 /* MCR          */
                      ...
                      struct {                          /*  Bit  Access */
                             ...
                             unsigned short SLPMR :1;   /*    SLPMR     */
                             unsigned short       :1;   /*              */
                             unsigned short SLPM  :1;   /*    SLPM      */
                             unsigned short       :2;   /*              */
                             unsigned short MTM   :1;   /*    MTM       */
                ...
                union {                                 /* IRR          */
                      ...
                      struct {                          /*  Bit  Access */
                             ...
                             unsigned short BOIF  :1;   /*    BOIF      */
                             unsigned short TCMIF2:1;   /*    TCMIF2    */
                             unsigned short CCOVIF:1;   /*    CCOVIF    */
                             unsigned short URIF  :1;   /*    URIF      */
                ...
                union {                                 /* IMR          */
                      ...
                      struct {                          /*  Bit  Access */
                             ...
                             unsigned short BOIM  :1;   /*    BOIM      */
                             unsigned short TCMI2M:1;   /*    TCMI2M    */
                             unsigned short CCOVIM:1;   /*    CCOVIM    */
                             unsigned short URIM  :1;   /*    URIM      */
                ...
                union {                                 /* TCR          */
                      ...
                      struct {                          /*  Bit  Access */
                             ...
                             unsigned short DICR0 :1;   /*    DICR0     */
                             unsigned short TSCR  :1;   /*    TSCR      */
                             unsigned short TSCT  :1;   /*    TSCT      */
                             unsigned short TCSCT :1;   /*    TCSCT     */
                             unsigned short TCSCC :1;   /*    TCSCC     */
                             unsigned short ICR0AD:1;   /*    ICR0AD    */
                             unsigned short       :3;   /*              */
                ...
                union {                                 /* TSR          */
                      ...
                      struct {                          /*  Bit  Access */
                             unsigned short      :11;   /*              */
                             unsigned short CCOVF: 1;   /*    CCOVF     */
                             unsigned short CMF2 : 1;   /*    CMF2      */
                             unsigned short CMF1 : 1;   /*    CMF1      */
                             unsigned short CMF0 : 1;   /*    CMF0      */
                ...
                struct {                                /* MB           */
                   ...
                   union {                              /* LAFM(Low)    */
                         ...
                         struct {                       /*  TTT  Access */
                                unsigned short      : 4;/*              */
                                unsigned short O    : 4;/*    Offset    */
                                unsigned short      : 4;/*              */
                                unsigned short RC   : 4;/*    Rep_Count */
                                }       TTT;            /*              */
                         }          LAFML;              /*              */
                   char             wk[12];             /*              */
                }               MB[32];                 /*              */
