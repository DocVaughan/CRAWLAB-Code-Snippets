...
void INT_H_UDI(void) __attribute__ ((interrupt_handler));
...
void INT_MTU0_TGIA0(void) __attribute__ ((interrupt_handler));

// 89 MTU0 TGIB0

void INT_MTU0_TGIB0(void) __attribute__ ((interrupt_handler));

// 90 MTU0 TGIC0

void INT_MTU0_TGIC0(void) __attribute__ ((interrupt_handler));

// 91 MTU0 TGID0

void INT_MTU0_TGID0(void) __attribute__ ((interrupt_handler));

// 92 MTU0 TCIV0

void INT_MTU0_TCIV0(void) __attribute__ ((interrupt_handler));
...
void INT_MTU1_TGIA1(void) __attribute__ ((interrupt_handler));

// 97 MTU1 TGIB1

void INT_MTU1_TGIB1(void) __attribute__ ((interrupt_handler));
...
void INT_MTU1_TCIV1(void) __attribute__ ((interrupt_handler));

// 101 MTU1 TCIU1

void INT_MTU1_TCIU1(void) __attribute__ ((interrupt_handler));
...
void INT_MTU2_TGIA2(void) __attribute__ ((interrupt_handler));

// 105 MTU2 TGIB2

void INT_MTU2_TGIB2(void) __attribute__ ((interrupt_handler));
...
void INT_MTU2_TCIV2(void) __attribute__ ((interrupt_handler));

// 109 MTU2 TCIU2

void INT_MTU2_TCIU2(void) __attribute__ ((interrupt_handler));
...
void INT_MTU3_TGIA3(void) __attribute__ ((interrupt_handler));

// 113 MTU3 TGIB3

void INT_MTU3_TGIB3(void) __attribute__ ((interrupt_handler));

// 114 MTU3 TGIC3

void INT_MTU3_TGIC3(void) __attribute__ ((interrupt_handler));

// 115 MTU3 TGID3

void INT_MTU3_TGID3(void) __attribute__ ((interrupt_handler));

// 116 MTU3 TCIV3

void INT_MTU3_TCIV3(void) __attribute__ ((interrupt_handler));
...
void INT_MTU4_TGIA4(void) __attribute__ ((interrupt_handler));

// 121 MTU4 TGIB4

void INT_MTU4_TGIB4(void) __attribute__ ((interrupt_handler));

// 122 MTU4 TGIC4

void INT_MTU4_TGIC4(void) __attribute__ ((interrupt_handler));

// 123 MTU4 TGID4

void INT_MTU4_TGID4(void) __attribute__ ((interrupt_handler));
...
void INT_CMT_CMT0(void) __attribute__ ((interrupt_handler));
...
void INT_CMT_CMT1(void) __attribute__ ((interrupt_handler));
...
void INT_MTUOEI(void) __attribute__ ((interrupt_handler));
...
void INT_MMT_TGIM(void) __attribute__ ((interrupt_handler));

// 181 MMT TGIN

void INT_MMT_TGIN(void) __attribute__ ((interrupt_handler));
...
void INT_ADI2(void) __attribute__ ((interrupt_handler));
...
void INT_MMTOEI(void) __attribute__ ((interrupt_handler));
...
void INT_HCAN2_ERS1(void) __attribute__ ((interrupt_handler));

// 209 HCAN2 OVR1

void INT_HCAN2_OVR1(void) __attribute__ ((interrupt_handler));

// 210 HCAN2 RM1

void INT_HCAN2_RM1(void) __attribute__ ((interrupt_handler));

// 211 HCAN2 SLE1

void INT_HCAN2_SLE1(void) __attribute__ ((interrupt_handler));
