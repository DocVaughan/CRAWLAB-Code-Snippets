...
src/SH2Tiny_BasicSerial.o: ../src/SH2Tiny_BasicSerial.c
	@echo 'Scanning and building file: $<'
	@echo 'Invoking: Scanner and Compiler'
	@sh-elf-gcc -MM -MP -MF "src/SH2Tiny_BasicSerial.d" -MT"src/SH2Tiny_BasicSerial.o" -MT"src/SH2Tiny_BasicSerial.d" @"src/SH2Tiny_BasicSerial.depsub" "$<"
	@echo	sh-elf-gcc -MM -MP -MF "src/SH2Tiny_BasicSerial.d" -MT"src/SH2Tiny_BasicSerial.o" -MT"src/SH2Tiny_BasicSerial.d" -x c   -fomit-frame-pointer -DINIT_SECTIONS -D__BIG_ENDIAN__=1 -O2 -g -m2 -mb "$<"
	@sh-elf-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/SH2Tiny_BasicSerial.sub" -o "$(@:%.d=%.o)" "$<"
...
src/%.o: ../src/%.c
	@echo 'Scanning and building file: $<'
	@echo 'Invoking: Scanner and Compiler'
	@sh-elf-gcc -MM -MP -MF ""$(@:%.o=%.d)"" -MT"$(@:%.o=%.o)" -MT""$(@:%.o=%.d)"" @"src/c.depsub" "$<"
	@echo	sh-elf-gcc -MM -MP -MF "$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -x c   -fomit-frame-pointer -DINIT_SECTIONS -D__BIG_ENDIAN__=1 -O2 -g -m2 -mb "$<"
	@sh-elf-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/c.sub" -o "$(@:%.d=%.o)" "$<"
	@echo sh-elf-gcc -c -x c  -Wa,-adlhn="$(basename $(notdir $<)).lst" -fomit-frame-pointer -DINIT_SECTIONS -D__BIG_ENDIAN__=1 -O2 -g -m2 -mb -o "$(@:%.d=%.o)" "$<"
	@echo 'Finished scanning and building: $<'
	@echo.
